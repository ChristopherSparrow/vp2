...
<div class="container mx-auto py-4">
    <div class="bg-white shadow rounded-lg p-4">
        <h2 class="text-xl font-semibold mb-3">Fixtures / Results</h2>
                    ...
                    <tbody>
                        @foreach($byDate as $date => $dateFixtures)
                            ...
                            <tr class="bg-gray-100">
                                <td class="px-3 py-2 font-medium" colspan="5">{{ $displayDate }}</td>
                            </tr>

                            @foreach($byCompetition as $competitionName => $compFixtures)
                                <tr class="bg-gray-50">

                                    <td class="px-3 py-2" colspan="4">{{ $competitionName }}</td>
                                </tr>
